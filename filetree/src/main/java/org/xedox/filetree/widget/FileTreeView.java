...
public class FileTreeView extends RecyclerView {
    ...
    public void loadPath(File path) {
        Node root = new Node(path.getAbsolutePath());
        adapter.setRoot(root);
    }
    ...
    // Methods copyed from FileTreeAdapter for comfortable

    public void setIcon(String pattern, int drawableResId) {
        adapter.setIcon(pattern, drawableResId);
    }

    public void removeIcon(String pattern) {
        adapter.removeIcon(pattern);
    }
    ...
    public void setFileItemLayout(int fileItemLayout) {
        adapter.setFileItemLayout(fileItemLayout);
    }

    public void setOnFileClickListener(FileTreeAdapter.OnFileClickListener listener) {
        adapter.setOnFileClickListener(listener);
    }

    public void setOnFileLongClickListener(FileTreeAdapter.OnFileLongClickListener listener) {
